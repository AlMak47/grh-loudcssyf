        ...
        <div class="row">
            <div class="col s12 m12 l6">
                <ul class="collection with-header">
                    ...
                    <li v-for="i in 10" :key="i" class="collection-item avatar">
                        <span class="title">Responsable Commercial</span>
                        <p>Description</p>
                        ...
                        <!-- <div>Alvin
                            <span href="#!" class="secondary-content">
                                <a class="btn btn-small btn-floating blue darken-1"><i class="material-icons">edit</i></a>
                            </span>
                        </div> -->
                    </li>
                </ul>
                                ...
                                <form @submit.prevent="">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 m12 l12">
                                            ...
                                            <input type="number" id="icon_prefix" class="validate">
